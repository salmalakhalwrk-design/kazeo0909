            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: isCenter
                    ? "0 18px 45px rgba(7,17,31,0.35), 0 0 30px rgba(38,182,221,0.18)"
                    : "0 10px 25px rgba(7,17,31,0.2)",
              ...
              >
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(180deg, rgba(7,17,31,0.18) 0%, rgba(7,17,31,0) 30%, rgba(7,17,31,0.35) 65%, rgba(7,17,31,0.72) 100%)",
                    pointerEvents: "none",
                    zIndex: 10,
                  }}
                />
